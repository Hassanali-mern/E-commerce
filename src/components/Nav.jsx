  ...
  return (
    <div className='h-[100%] lg:h-[70%] w-[100%] max-w-[1400px] flex justify-center  '>
      <div className='h-[100%] w-[25%] lg:w-[20%] hidden lg:flex gap-5 items-center justify-center'>
        <>
          <svg
            className="w-7 h-7 social-links text-gray-800 dark:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" viewBox="0 0 24 24"
          >
            <path
              fillRule="evenodd"
          ...
          <svg
            className="w-6 h-7 social-links text-gray-800 dark:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24"
          >
            <path
