          ...
          <table className=' h-auto w-full max-w-[900px] flex flex-col gap-10 md:gap-0'>
            ...
            <tr aria-colspan={6} className='h-[80px] w-full flex justify-between border-[1px] border-neutral-300 dark:border-neutral-800 p-[10px] box-border'>
              <div className='flex gap-3 items-center'>
                <input
                  className='h-[50px] w-[250px] text-black dark:text-neutral-200 px-[10px] text-[1.2em] font-semibold border-[1px]   dark:border-neutral-800'
                  type="text" placeholder='Coupon code' />
                <button className='h-[45px] w-[200px] rounded-[10px] bg-neutral-800 dark:bg-neutral-100 text-gray-200 dark:text-black font-bold text-[1.2em] cursor-pointer'>Apply Coupon</button>
              </div>
              <div className='flex justify-end items-center'>
                <button className='h-[45px] w-[250px] text-gray-200 dark:text-black rounded-[10px] text-[1.2em] font-bold bg-neutral-800 dark:bg-neutral-100 cursor-pointer'>Update Cart</button>
              </div>
            </tr>
          </table>
