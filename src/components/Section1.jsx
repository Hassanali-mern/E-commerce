            ...
            <div className='h-[85%] w-[100%] flex justify-center items-center bg-[url(/images/social.jpg)] bg-cover bg-no-repeat bg-center'>
                <div className='flex justify-start w-[50%]'>
                    ...
                    <div className='flex flex-col gap-5 md:gap-2 items-center md:items-end w-[100%] md:w-[40%] text-gray-50'>
                        <div className='flex gap-3 justify-center md:justify-start items-baseline relative'>
                            <span>____________________________ </span> <span className='text-[1.5em] md:text-[2em] px-[10px] font-semibold bg-[url(/images/social.jpg)] sm:bg-none bg-[1050px]  md:static absolute right-15 rounded-[10px] '>  BAG</span>
                        </div>
