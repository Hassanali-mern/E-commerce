          ...
          <div className='w-full max-w-[1400px] p-[15px] flex flex-col items-center'>
            <table className='border-[1px] border-neutral-800 h-auto w-full max-w-[900px] flex flex-col'>
              <tr className='w-full flex bg-[#061817] text-neutral-50 text-[1.2em] '>
                <th className='h-[60px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse p-[10px]'></th>
                <th className='h-[60px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse p-[10px]'></th>
                <th className='h-[60px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse p-[10px]'>Product</th>
                <th className='h-[60px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse p-[10px]'>Price</th>
                <th className='h-[60px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse p-[10px]'>Quantity</th>
                <th className='h-[60px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse grow p-[10px]'>Subtotal</th>
              </tr>
              {cart.map((item) =>
                <tr className='w-full text-neutral-400 text-[1.1em] flex font-semibold' >
                  ...
                  <td className='h-[150px] w-[16.5%] flex justify-center items-center text-red-500 border-[1px] border-neutral-800 border-collapse p-[10px] box-border'>
                  ...
                  <td className='h-[150px] w-[16.5%] flex justify-center items-center text-[1.1em] border-[1px] border-neutral-800  border-collapse p-[10px] box-border'>
                    <span>{`$${products[item.pid - 1].price}`}</span>
                  </td>
                  <td className='h-[150px] w-[16.5%] flex justify-center items-center border-[1px] border-neutral-800 border-collapse p-[10px] box-border'>
                    <input type="number" defaultValue={item.qt} min={1} className='h-[50px] w-[55px] border-[1px] outline-0 border-neutral-800 text-[1.1em] p-[10px]' />
                  </td>
                  <td className='h-[150px] w-[16.5%] flex justify-center items-center text-[1.1em] grow border-[1px] border-neutral-800 border-collapse'>
                    <span>{`$${products[item.pid - 1].price * item.qt}`}</span>
                  </td>
                </tr>
              )}
              <tr aria-colspan={6} className='h-[80px] w-full flex justify-between border-[1px] border-neutral-800 p-[10px] box-border'>
                <div className='flex gap-3 items-center'>
                  <input 
                  className='h-[50px] w-[250px] text-neutral-200 px-[10px] text-[1.2em] font-semibold border-[1px] border-neutral-700'
