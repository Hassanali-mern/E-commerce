...
const ToggleNav = () => {
    ...
    return (
        ...
        <>
            <div className={`w-full h-[400px] flex flex-col translate-x-[${!isToggle ? '-100%' : '0'}] [transition:all_0.4s_ease-in-out] absolute top-0 left-0 bg-black z-1 border-t-[1px] border-neutral-700`} >
