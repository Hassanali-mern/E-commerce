...
const Product = memo(({ product }) => {
  ...
  return (
    <>
      {product ?
        <div className='flex flex-col items-center  gap-3 h-[400px] w-[320px] product-div '>
          ...
          {true ? <button onClick={() => { setCart([...cart, 'abc']) }} className='h-[45px] w-[120px] add-btn lg:hidden  bg-gray-50  text-[1em] font-bold  cursor-pointer mt-1'>ADD TO CART</button> : null}
        </div>
        :
