    ...
    return (
        <div >
            ...
            <div className='h-[800px]'>
                ...
                <div className='h-[85%] w-[100%] flex justify-center items-center bg-[url(/images/social-light.webp)] dark:bg-[url(/images/social.jpg)] bg-cover bg-no-repeat bg-center'>
                ...
                <div className='h-[15%] w-[100%] flex  justify-center' >
                    <div className='flex grow-1 justify-center items-center border-neutral-200 dark:border-neutral-700 border-[1px]'>
                        <img
                            className='h-auto w-[160px] aspect-[2/1]'
                            src={(theme === "dark")?'/images/digital-cube.jpg':'/images/digital-light.webp'} alt="" />
                    </div>
                    <div className='flex grow-1 justify-center items-center border-neutral-200 dark:border-neutral-700 border-[1px]'>
                        <img
                            className='h-auto w-[160px] '
                            src={(theme === "dark")?'/images/vende.jpg':'/images/vende-light.webp'} alt="" />
                    </div>
                    <div className='flex grow-1 justify-center items-center border-neutral-200 dark:border-neutral-700 border-[1px]'>
                        <img
                            className='h-auto w-[160px] aspect-[2/1]'
                            src={(theme === "dark")?'/images/mangentle.jpg':'/images/mangentle-light.webp'} alt="" />
                    </div>
                    <div className='hidden sm:flex grow-1 justify-center items-center border-neutral-200 dark:border-neutral-700 border-[1px]'>
                        <img
                            className='h-auto w-[160px] aspect-[2/1]'
                            src={(theme === "dark")?'/images/img.jpg':'/images/img-light.webp'} alt="" />
                    </div>
                    <div className='hidden sm:flex grow-1 justify-center items-center border-neutral-200 dark:border-neutral-700 border-[1px]'>
                        <img
                            className='h-auto w-[160px] aspect-[2/1]'
                            src={(theme === "dark")?'/images/jewellery.jpg':'/images/jewellery-light.webp'} alt="" />
                    </div>
                    <div className='hidden lg:flex grow-1 justify-center items-center border-neutral-200 dark:border-neutral-700 border-[1px] '>
                        <img
                            className='h-auto w-[160px] aspect-[2/1] '
                            src={(theme === "dark")?'/images/luxury.jpg':'/images/luxury-light.webp'} alt="" />
                    </div>
                </div>
