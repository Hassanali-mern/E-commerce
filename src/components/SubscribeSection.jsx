  ...
  return (
    <div className='h-[1500px] md:h-[750px] w-full flex justify-center'>
      <div className='h-full w-full max-w-[1400px] flex flex-col md:flex-row px-[20px] py-[30px]'>
        ...
        <div className='h-[50%] md:h-full w-full md:w-[50%] bg-slate-100 dark:bg-[#021e1e] flex flex-col justify-center items-center gap-5'>
          <div className='h-[110px] w-full flex flex-col gap-3 justify-end items-center text-black dark:text-gray-50  p-[10px] box-border'>
            <div className='flex gap-4'>
              <span>_________</span>
              <span className='text-[1.2em] md:text-[1.5em] font-semibold text-neutral-700 dark:text-gray-300 text-center'>Newsletter </span>
              <span>_________</span>
            </div>
            <h2 className='text-[2em] lg:text-[3.5em] text-black dark:text-gray-50 font-bold uppercase text-center'>Subscribe</h2>
          </div>
          <div className='flex flex-col gap-10 items-center'>
            <p className='text-[1.5em] text-gray-500 text-center'>Sign up now for 10% discount on first order.</p>
